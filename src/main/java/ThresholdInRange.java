...
public class ThresholdInRange {
    ...
    private class CaptureTask extends SwingWorker<Void, Mat> {
        ...
        protected void process(List<Mat> frames) {
            ...
            update(frame, thresh);
            System.out.println(new Scalar(sliderLowH.getValue(), sliderLowS.getValue(), sliderLowV.getValue()) + " " +
    ...
    private void addComponentsToPane(Container pane, Image img) {
        ...
        JPanel sliderPanel = new JPanel();//[112.0, 113.0, 132.0, 0.0] [122.0, 255.0, 255.0, 0.0]
        sliderPanel.setLayout(new BoxLayout(sliderPanel, BoxLayout.PAGE_AXIS));
        sliderPanel.add(new JLabel(LOW_H_NAME));
        sliderLowH = new JSlider(0, MAX_VALUE_H, 112);
        ...
        sliderHighH = new JSlider(0, MAX_VALUE_H, 122);
        ...
        sliderLowS = new JSlider(0, MAX_VALUE, 113);
        ...
        sliderHighS = new JSlider(0, MAX_VALUE, 255);
        ...
        sliderLowV = new JSlider(0, MAX_VALUE, 132);
